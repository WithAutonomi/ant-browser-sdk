...
export const browsernetworkclient_uploadPublicFile: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: any, i: any, j: number, k: number, l: number, m: number) => any;
export const browsernetworkclient_uploadStagedPublicFile: (a: number, b: any, c: any, d: any, e: any, f: number, g: number, h: number, i: number) => any;
...
export const wasm_bindgen__convert__closures_____invoke__hcf1ef00f54a9d4fb: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hcf1ef00f54a9d4fb_2: (a: number, b: number, c: any) => void;
