...
export const browsernetworkclient_connect: (a: number, b: number) => any;
export const browsernetworkclient_downloadPrivateFile: (a: number, b: any, c: number, d: number) => any;
...
export const browsernetworkclient_openPrivateFile: (a: number, b: any, c: number) => any;
...
export const browsernetworkclient_uploadRecords: (a: number, b: any, c: any, d: any, e: any, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => any;
...
export const wasm_bindgen__convert__closures_____invoke__h0adb10753c7fca5a: (a: number, b: number, c: any) => any;
export const wasm_bindgen__convert__closures_____invoke__h5206e33babbdebc1: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h5206e33babbdebc1_3: (a: number, b: number, c: any) => void;
