...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h87ed8a58f2a8ddd5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h87ed8a58f2a8ddd5_2: (a: number, b: number, c: any) => void;
